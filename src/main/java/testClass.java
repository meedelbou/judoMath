...
public class testClass {
    ...
    public static void main(String[] args) throws Exception {
        System.out.print("Nombre en mots : ");
        Scanner in = new Scanner(System.in);
        String texteMotsNombre = in.nextLine();
        long valeurNumerique = testClass.convertir(texteMotsNombre);
        System.out.println("Valeur : " + testClass.AvecSeparateur(valeurNumerique));
    }
}
