                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <div >
                                                ...
                                                <h3 class="text-primary">Résultats détaillés de votre test </h3>  <br>  
                                                <div >
                                                        ...
                                                        <div class="row" style ="padding:0% 8%"  >
                                                            ...
                                                            <div class="basic-form">
                                                                <div class="mb-3 mb-0" style="padding:3%;padding-left:0">
                                                                    ...
                                                                    <a class="badge-rounded light badge-success" style="padding:1%"> <strong><%=answersTest.get(countE - 1)%> </strong> &nbsp;  ✅ Cette Réponse est Correcte</a>

                                                                    <%} else {%>

                                                                    <a class="badge-rounded light badge-danger" style="padding:1%"> <strong> <%=answersTest.get(countE - 1)%> </strong>   &nbsp;   ❌ Cette Réponse est Incorrecte</a> <br><br><br>
                                                    ...
                                                    <div id="wizard_Finish" class="tab-pane" role="tabpanel">
                                                        <c:if test="${not empty passed}">
                                                            ...
                                                            <div class="row emial-setup" style="text-align: center">
                                                                ...
                                                                <div class="sweetalert">
                                                                    <button class="btn btn-success btn" type="button"    data-bs-toggle="modal" data-bs-target="#exampleModalpopover" id="unlock" onclick="recommendCompetences();">Devrouiller les competences !</button>
                                                                </div>
                                                                <div class="modal fade" id="exampleModalpopover">
                                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Choisissez votre prochaine compétence !</h5>
                                                        ...
                                                        <c:if test="${not empty failed}">
                                                            ...
                                                            <form method="post" action="ApprentissageAdaptatif" style="text-align:center">
                                                                <button class="btn  btn-primary"> S'entrainer à nouveau</button>
                                                            </form>
                                                        </c:if>
                                                        <c:if test="${not empty passed_palier}">
                                                            <div style="text-align:center">
                                                                <a  href="ApprentissageAdaptatif" class="btn btn-outline-success  btn-card">Continuer apprentissage</a>
                                                            ...
                                                            <div class="col-lg-4 col-md-6 mb-4">
                                                                <div class="card">
                                                                    <div class="card-body text-center ai-icon  text-primary">
                                                                        ...
                                                                        <p style="color:black"> L'évaluation s'adaptera automatiquement à votre niveau de compétence.</p>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body text-center ai-icon  text-primary">
                                                                        ...
                                                                        <%
                                                                            ...
                                                                            String obj = "Vous serez évalué sur " + c + " palier " + palier + "/3.";
                                                                            if (palier == 3) {
                                                                                obj = "Vous serez évalué sur " + c + " palier " + palier + "/3.<br> <strong>Vous allez valider la competence !</strong>";
                                                                            }
        ...
        <!--                                                        <div class="alert alert-warning alert-dismissible fade show" style="visibility:hidden" id="alerte_<%=countE%>">
                                                    ...
                                                    <div id="wizard_Finish" class="tab-pane" role="tabpanel">
                                                        <div class="row emial-setup" style="text-align: center">
                                                            ...
                                                            <p>Vous avez terminé les exercises du competence ${c} </p>
                                                            <div>
                                                                <button type="submit" class="btn btn-primary">Valider votre réponses</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
