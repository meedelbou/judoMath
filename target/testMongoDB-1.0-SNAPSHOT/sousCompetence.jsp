            ...
            <div class="content-body">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="competences?cd=${cd}">${cd}</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">${ci}</a></li>
                    </ol>
                            ...
                            <div class="card-body pb-1">
                                <div id="lightgallery" class="row">
                                    <div class="col-lg-3 col-md-6 mb-4">
                                        <div class="card">
                                            <div class="card-body text-center ai-icon  text-primary">
                                                ...
                                                <h4 class="my-2">Entiers</h4>
                                                <a href="afficherCours?c=Entiers" class="btn my-2 btn-primary btn-lg px-4"></i> Commencer</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 mb-4">
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-4">
                                        <div class="card">
                                            <div class="card-body text-center ai-icon  text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" height="80" class="my-2" width="80"  stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round"viewBox="0 0 32 32">
                                                <path d="M 29 2 C 28.744138 2 28.488269 2.0976687 28.292969 2.2929688 L 2.2929688 28.292969 C 1.9023687 28.683669 1.9023687 29.316431 2.2929688 29.707031 C 2.4882687 29.902331 2.7441 30 3 30 C 3.2559 30 3.5116312 29.902331 3.7070312 29.707031 L 29.707031 3.7070312 C 30.097631 3.3163313 30.097731 2.6835688 29.707031 2.2929688 C 29.511681 2.0976687 29.255862 2 29 2 z M 3 6 C 2.7441375 5.9999875 2.4882688 6.0976188 2.2929688 6.2929688 C 1.9023687 6.6836688 1.9023687 7.3164312 2.2929688 7.7070312 L 5.5859375 11 L 2.2929688 14.292969 C 1.9023687 14.683669 1.9023687 15.316431 2.2929688 15.707031 C 2.4882687 15.902331 2.7441 16 3 16 C 3.2559 16 3.5116313 15.902331 3.7070312 15.707031 L 7 12.414062 L 10.292969 15.707031 C 10.488269 15.902331 10.7441 16 11 16 C 11.2559 16 11.511631 15.902331 11.707031 15.707031 C 12.097631 15.316331 12.097631 14.683569 11.707031 14.292969 L 8.4140625 11 L 11.707031 7.7070312 C 12.097631 7.3163312 12.097731 6.6835688 11.707031 6.2929688 C 11.316331 5.9023688 10.683569 5.9023687 10.292969 6.2929688 L 7 9.5859375 L 3.7070312 6.2929688 C 3.5116813 6.0976687 3.2558625 6.0000125 3 6 z M 22 16 C 21.744138 15.999987 21.488269 16.097619 21.292969 16.292969 C 20.902369 16.683669 20.902369 17.316431 21.292969 17.707031 L 25.169922 21.583984 L 21.136719 28.496094 C 20.858419 28.973194 21.018994 29.584981 21.496094 29.863281 C 21.654794 29.955581 21.827147 30 21.998047 30 C 22.342347 30 22.677181 29.822306 22.863281 29.503906 L 29.863281 17.503906 C 30.141581 17.026806 29.981006 16.415019 29.503906 16.136719 C 29.025806 15.857919 28.414519 16.019494 28.136719 16.496094 L 26.210938 19.796875 L 22.707031 16.292969 C 22.511681 16.097669 22.255862 16.000013 22 16 z"></path>
                                                </svg>
                                                <h4 class="my-2">Fractions</h4>
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-4">
                                        <div class="card">
                                            <div class="card-body text-center ai-icon  text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="80" class="my-2" width="80"  stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 32 32">
                                                <path d="M10 26c0 2.209-1.791 4-4 4s-4-1.791-4-4c0-2.209 1.791-4 4-4S10 23.791 10 26zM30 2.5v6C30 8.776 29.776 9 29.5 9h-6C23.224 9 23 8.776 23 8.5v-6C23 2.224 23.224 2 23.5 2h6C29.776 2 30 2.224 30 2.5zM9.488 16.512L6 20l-3.488-3.488C2.323 16.323 2.457 16 2.724 16H5V8c0-2.209 1.791-4 4-4h11.5C20.776 4 21 4.224 21 4.5v1C21 5.776 20.776 6 20.5 6H9C7.895 6 7 6.895 7 8v8h2.276C9.543 16 9.677 16.323 9.488 16.512zM29.276 15H27v8c0 2.209-1.791 4-4 4H12.5c-.276 0-.5-.224-.5-.5v-1c0-.276.224-.5.5-.5H23c1.105 0 2-.895 2-2v-8h-2.276c-.267 0-.401-.323-.212-.512L26 11l3.488 3.488C29.677 14.677 29.543 15 29.276 15z"></path>
                                                </svg>
                                                <h4 class="my-2">Conversion</h4>
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-4" style="display:none">
                                        <div class="card">
                                            <div class="card-body text-center ai-icon  text-primary" >
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="80" class="my-2" width="80"  stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 32 32">
                                                <path d="M 9.5 6 C 7.578125 6 6 7.578125 6 9.5 L 6 12.5 C 6 14.421875 7.578125 16 9.5 16 C 11.421875 16 13 14.421875 13 12.5 L 13 9.5 C 13 7.578125 11.421875 6 9.5 6 Z M 20.75 6 L 8.75 26 L 11.25 26 L 23.25 6 Z M 9.5 8 C 10.339844 8 11 8.660156 11 9.5 L 11 12.5 C 11 13.339844 10.339844 14 9.5 14 C 8.660156 14 8 13.339844 8 12.5 L 8 9.5 C 8 8.660156 8.660156 8 9.5 8 Z M 22.5 16 C 20.578125 16 19 17.578125 19 19.5 L 19 22.5 C 19 24.421875 20.578125 26 22.5 26 C 24.421875 26 26 24.421875 26 22.5 L 26 19.5 C 26 17.578125 24.421875 16 22.5 16 Z M 22.5 18 C 23.339844 18 24 18.660156 24 19.5 L 24 22.5 C 24 23.339844 23.339844 24 22.5 24 C 21.660156 24 21 23.339844 21 22.5 L 21 19.5 C 21 18.660156 21.660156 18 22.5 18 Z"></path>
                                                </svg>
                                                <h4 class="my-2">Proportionnalité</h4>
                                                <a href="afficherCours?c=Proportionnalite"  class="btn my-2 btn-primary btn-lg px-4"></i> Commencer</a>
