...
<%
    List<QuerySolution> solutions = (List<QuerySolution>) request.getAttribute("solutions");
                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li> <a href="afficherCours?c=Entiers"> Entiers </a></li>
                                <li> <a href="afficherCours?c=Decimaux"> Decimaux </a></li>
                                <li> <a href="afficherCours?c=Conversion"> Conversion </a></li>
                                <li> <a href="afficherCours?c=Fraction"> Fractions </a></li>
                                <li> <a href="afficherCours?c=Proportionnalite"> Proportionnalité </a></li>
                        ...
                        <li><a href="javascript:void(0);" aria-expanded="false">
                                ...
                                <span class="nav-text">Apprentissage adapté</span>
                            </a>
                        </li>
                                ...
                                <div class="tab-pane fade show active" id="WithBadges" role="tabpanel" aria-labelledby="home-tab4">
                                    <div class="card-body">
                                        <div class="basic-list-group">
                                            <span style ="color:black">${title}</span><br><br>
                                            <ul class="list-group">
                                                <%

                                                    String c = (String) request.getAttribute("c");
                                                    for (QuerySolution solution : solutions) {
                                                        RDFNode Class2 = solution.get("name");
                                                        Matcher matcher = pattern.matcher(Class2.toString());

                                                        String result = matcher.find() ? matcher.group(1) : c;
                                                ...
                                                %>
                                                 ...
                                                 <% if(result.equals(c)) { 
                                                     ...
                                                     Matcher matcher2 = pattern.matcher(solution.get("individual").toString());

                                                     String result2 = matcher2.find() ? matcher2.group(1) : "GHALAT";
                                                     
                                                 %>
                                                
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    <a href="learning?c=<%=result2%>"> <%=Class2.toString()%></a> <span class="badge badge-primary badge-pill">30%</span>
                                                </li>
                                                ...
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    <a href="afficherCours?c=<%=result%>"> <%=Class2.toString()%></a> <span class="badge badge-primary badge-pill">30%</span>
                                                </li>
                                                <% }%>
