                                            ...
                                            <div class="header-info2 d-flex align-items-center">
                                                <div class="header-media">
                                                    <%
                                                        ...
                                                        String base64Img = Base64.getEncoder().encodeToString(user.getProfilePicture());
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                            <div class="card border-0 mb-0">
                                                <div class="card-header py-2">
                                                    <div class="products">
                                                        <img src="data:image/png;base64,<%=base64Img%>" class="avatar avatar-md" alt="">
                                                        <div>
                                                            <h6>${user.prenom} ${user.nom}</h6>
                                                            <span>${user.role}</span>	
                                                        </div>	
            ...
            <div class="deznav">
                <div class="deznav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a href="etudiants.jsp" class="" aria-expanded="false">
                                <div class="menu-icon">
    ...
    ***********************************-->
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <img class="rounded-circle" width="35" src="data:image/png;base64,<%=base64Image%>" alt="User Image">
            ...
            ***********************************-->
            <div class="footer out-footer">
                <div class="copyright">
                    <p>Copyright © Mohamed at ELLIAD <a href="https://dexignzone.com/" target="_blank">Mohamed</a> 2023</p>
                </div>
            </div>
            <!--**********************************
                Footer end
