<%-- 
    Document   : accueil_teacher
    Created on : 11 juin 2023, 19:48:10
    Author     : medel
--%>
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Customer Manager<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
                                    <ul aria-expanded="false">
                                        <li><a href="./students.jsp.html">Customer</a></li>
                                ...
                                <div class="card-body  p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <h3 class="text-white">${user.etudiants.size()}</h3>
                                            <div class="progress mb-2 bg-secondary">
                                                <div class="progress-bar progress-animated bg-white" style="width: ${user.calculatePercentageIncrease(-20)}%"></div>
                                            </div>
                                            <small>${user.calculatePercentageIncrease(-20)}% Increase in 20 Days</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-white">
                                            ...
                                            <small>${user.calculatePercentageIncrease(-25)}% Increase in 25 Days</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img class="rounded-circle" width="35" src="data:image/jpeg;base64,<%=base64Image%>" alt="User Image">

                                                    </td>
                                                    <td><a href="profilEtudiant?email=<%=etudiant.getEmail()%>"><strong><%=etudiant.getNom()%> <%=etudiant.getPrenom()%></strong></a></td>
                                                    <td><%=etudiant.getEmail()%></td>
                                                    <td><%=etudiant.getExperiencePoints()%></td>
                                                    <td><%=etudiant.getNumberOfVisits()%></td>
                                                    <td><%=etudiant.getLastLogin()%></td>
                                                    <td><%=etudiant.getDateOfSignup()%></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <% String check = etudiant.isAccesToTest() ? "checked" : "";%>
                                                            <!--<a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>-->
                                                            <input type="checkbox" id="myCheckbox_<%=etudiant.getEmail()%>" name="myCheckbox_<%=etudiant.getEmail()%>" value="<%=etudiant.getEmail()%>" <%=check%>>
                                                            <label>Grant Access </label>
                                                            <!--<a href="suppEtudiant?email<%=etudiant.getEmail()%>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>-->
                                                        </div>
                                                    </td>
                                                </tr>
                                                <%}%> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="products">
                                                            ...
                                                            <div>
                                                                <h6><a href="app-profile-2.html"><%=etudiant.getNom()%> <%=etudiant.getPrenom()%></a></h6>
                                                                <span><%=etudiant.getRole()%></span>	
                                                            </div>	
                                                        </div>
                                                    </td>
                                                    <td><span><%=etudiant.getEmail()%> </span></td>
                                                    <td><a href="profilEtudiant?email=<%=etudiant.getEmail()%>"><strong><%=etudiant.getExperiencePoints()%></strong></a></td>
                                                    <td>
                                                        <span><%=etudiant.getNumberOfVisits()%></span>
                                                    </td>
                                                    <td>
                                                        <span><%=etudiant.getLastLogin()%></span>
                                                    </td>	
                                                    <td>
                                                        <span><%=etudiant.getDateOfSignup()%></span>
                                                    </td>
                                                    <td>
                    ...
                    if (event.target.classList.contains('myCheckbox')) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                console.log('Checkbox state updated successfully. ' + email);
                            },
