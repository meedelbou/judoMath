    ...
    ***********************************-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-xxl-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">Apprendre </h4>
                                                </div>
                                                <div class="card-body">
                                        ...
                                        <div class="col-xl-6 col-xxl-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">S'entrainer</h4>
                                                </div>
                                                <div class="card-body">
                                                    <div id="smartwizard" class="form-wizard order-create">
                                                        ...
                                                        <ul class="nav nav-wizard">
                                                            ...
                                                            %>
                                                            <li><a class="nav-link" href="#wizard_<%=count%>"> 
                                                                    <span><%=count%></span> 
                                                                </a></li>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="wizard_<%=countE%>" class="tab-pane" role="tabpanel">
                                                                ...
                                                                <div class="row" style="text-align:center">
                                                                    ...
                                                                    <div class="basic-form">
                                                                        <div class="mb-3 mb-0">
                                                                            <% for (Integer option : exercise.getOptions()) {%>
                                                            ...
                                                            <div id="wizard_Finish" class="tab-pane" role="tabpanel">
                                                                <div class="row emial-setup" style="text-align: center">
                                                                    ...
                                                                    <div>
                                                                        <button type="submit" class="btn btn-primary">Passer au compétence suivante !</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div id="wizard_<%=countE%>" class="tab-pane" role="tabpanel">
                                                                    ...
                                                                    <div class="row" style="text-align:center">
                                                                        ...
                                                                        <div class="basic-form">
                                                                            <div class="mb-3 mb-0">
                                                                                <% for (Integer option : exercise.getOptions()) {%>
                                                                                <div class="form-check custom-checkbox mb-2" style="display:inline-block;">
        ...
        ***********************************-->
        ...
        <script>
            ...
            var all = document.querySelectorAll("#smartwizard .nav-wizard .nav-link, #smartwizard button, .toolbar button");
